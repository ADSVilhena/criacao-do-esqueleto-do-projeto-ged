"""
Django settings for GerenciamentoEscolar project.
...
SECRET_KEY = '==)*1j6rhn(jf2003@qk__p5=1l03x@=hssx&6c#uo374ot+h%'
...
WSGI_APPLICATION = 'GerenciamentoEscolar.wsgi.application'
